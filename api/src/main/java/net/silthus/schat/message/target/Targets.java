...
import net.silthus.schat.filter.FilterableCollection;
...
public final class Targets extends AbstractSet<MessageTarget> implements MessageTarget, FilterableCollection<MessageTarget> {
     ...
     *
     * @param targets the targets for which an unmodifiable view is to be returned.
     ...
     * @since next
     */
    public static Targets of(final @NonNull MessageTarget @NonNull ... targets) {
